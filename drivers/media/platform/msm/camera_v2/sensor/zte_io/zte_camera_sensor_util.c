...
SENSOR_Map_Table SESNOR_MODULE_MAP[] = {
	{ 0x1645, "sunwin_ov16e10"},
	{ 0x8044, "zte_gc8034_137_t86"},
	{ 0x556, "zte_hi556_137_t86"}
};
...
void msm_sensor_register_sysdev(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	msm_sensor_sysdev_info[index].id = SESNOR_MODULE_MAP[index].id;
	msm_sensor_sysdev_info[index].module_name = s_ctrl->sensordata->sensor_module_name;

	msm_sensor_sysdev_info[index].sensor_name = SESNOR_MODULE_MAP[index].sensor_name;
